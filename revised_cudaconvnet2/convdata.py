...
class CIFARDataProvider(LabeledDataProvider):
    ...
    def get_next_batch(self):
        ...
        #print cropped.shape, self.data_dic[bidx]['labels'].shape
        #print [cropped, self.data_dic[bidx]['labels']]
...
class DummyConvNetLogRegDataProvider(LabeledDummyDataProvider):
    ...
    def get_next_batch(self):
        ...
        ##### EJ
        self.cropped_data = n.zeros(dic['data'].shape,dtype=n.single)
        n.copyto(self.cropped_data,dic['data'])
        #print [dic['data'], dic['labels']]
        #return epoch, batchnum, [dic['data'], dic['labels']]
        return epoch, batchnum, [self.cropped_data, dic['labels']]
